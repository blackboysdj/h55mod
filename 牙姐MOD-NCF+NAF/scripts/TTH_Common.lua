...
-- 基础数据ID
  ...
  -- 生物
    ...
    CREATURE_209 = 209
    CREATURE_210 = 210
    CREATURE_DEATHSHROUD_MORTARION_0 = 210
    CREATURE_211 = 211
    CREATURE_DEATHSHROUD_MORTARION_1 = 211
    CREATURE_212 = 212
    CREATURE_DEATHSHROUD_MORTARION_2 = 212
    CREATURE_213 = 213
    CREATURE_DEATHSHROUD_MORTARION_3 = 213
    CREATURE_214 = 214
    CREATURE_DEATHSHROUD_MORTARION_4 = 214
    CREATURE_215 = 215
    CREATURE_DEATHSHROUD_MORTARION_5 = 215
    CREATURE_216 = 216
    CREATURE_DEATHSHROUD_MORTARION_6 = 216
    CREATURE_217 = 217
    ...
    CREATURE_543 = 543
    CREATURE_NECROMANCY_TOOL_DEATHSHROUD_SLOT = 543
    CREATURE_544 = 544
    CREATURE_NECROMANCY_TOOL_DEATHSHROUD_POISONOUS = 544
    CREATURE_545 = 545
    CREATURE_546 = 546
    CREATURE_547 = 547
    CREATURE_548 = 548
    ...
    CREATURE_566 = 566
    CREATURE_567 = 567
    CREATURE_FORTRESS_TOOL_FearlessLord = 567
    CREATURE_568 = 568
  ...
  -- 数据表
      ...
      TTH_TABLE.Hero = {
        ...
        -- TOWN_NECROMANCY
          ...
          -- Reaver
            ...
            , ["Mortarion"] = {
              ["Id"] = 162
              , ["Text"] = "/Text/Game/Heroes/TTH_ALL/Mortarion/name.txt"
              , ["Race"] = TOWN_NECROMANCY
              , ["Class"] = TTH_ENUM.Reaver
              , ["Mastery"] = HERO_SKILL_NECROMANCY
              , ["Group"] = TTH_ENUM.GroupBalanceNec
        ...
        -- 攻击术
          , [6] = {
            ...
            , ["Perk"] = {
              ...
              , [309] = { -- 深入敌后
                ["Id"] = HERO_SKILL_BEHIND_ENEMY
                , ["Text"] = "/Text/TTH/Skills/Offence/309-BehindEnemy/Name.txt"
                , ["DependType"] = TTH_ENUM.SkillSimple
                , ["Depend"] = {
                  [1] = HERO_SKILL_OFFENSIVE_FORMATION
                }
              }
              , [82] = { -- 怒火中烧
    ...
    -- 宝物
      TTH_TABLE.Artifact = {
        ...
        , [ARTIFACT_RING_OF_THE_SHADOWBRAND] = {
          ...
          , ["Text"] = "/Text/TTH/Artifact/063-RingOfTheShadowbrand/Text.txt"
        }
        ...
        , [ARTIFACT_JINXING_BAND] = {
          ...
          , ["Text"] = "/Text/TTH/Artifact/073-JinxingBand/Text.txt"
        }
        , [ARTIFACT_OGRE_CLUB] = {
    ...
    -- 宝物表 维度: 等级
      TTH_TABLE.Artifact8Level = {
        [1] = {
          ...
          , [1] = ARTIFACT_FOUR_LEAF_CLOVER
          , [2] = ARTIFACT_GOLDEN_SEXTANT
          , [3] = ARTIFACT_CROWN_OF_MANY_EYES
          , [4] = ARTIFACT_BREASTPLATE_OF_PETRIFIED_WOOD
          , [5] = ARTIFACT_RING_OF_LIGHTING_PROTECTION
          , [6] = ARTIFACT_BOOTS_OF_INTERFERENCE
          , [7] = ARTIFACT_SKULL_HELMET
          , [8] = ARTIFACT_RIGID_MANTLE
          , [9] = ARTIFACT_WISPERING_RING
          , [10] = ARTIFACT_BEGINNER_MAGIC_STICK
          , [11] = ARTIFACT_BEARHIDE_WRAPS
          , [12] = ARTIFACT_EDGE_OF_BALANCE
          , [13] = ARTIFACT_RING_OF_UNSUMMONING
          , [14] = ARTIFACT_RES_BASIC
          , [15] = ARTIFACT_BUCKLER
        }
        , [2] = {
          [0] = ARTIFACT_TITANS_TRIDENT
          , [1] = ARTIFACT_NECKLACE_OF_BRAVERY
          , [2] = ARTIFACT_EVERCOLD_ICICLE
          , [3] = ARTIFACT_RING_OF_LIFE
          , [4] = ARTIFACT_RES_EXPERT
          , [5] = ARTIFACT_PHOENIX_FEATHER_CAPE
          , [6] = ARTIFACT_HELM_OF_ENLIGHTMENT
          , [7] = ARTIFACT_CHAIN_MAIL_OF_ENLIGHTMENT
          , [8] = ARTIFACT_VALORIOUS_ARMOR
          , [9] = ARTIFACT_EARTHSLIDERS
          , [10] = ARTIFACT_BONESTUDDED_LEATHER
          , [11] = ARTIFACT_HELM_OF_CHAOS
          , [12] = ARTIFACT_TAROT_DECK
          , [13] = ARTIFACT_RES_ADVANCED
          , [14] = ARTIFACT_LEGION_BASIC
          , [15] = ARTIFACT_STEADFAST
          , [16] = ARTIFACT_REINCARNATION
          , [17] = ARTIFACT_MONK_01
          , [18] = ARTIFACT_MONK_02
        }
        , [3] = {
          [0] = ARTIFACT_ICEBERG_SHIELD
          , [1] = ARTIFACT_WEREWOLF_CLAW_NECKLACE
          , [2] = ARTIFACT_LION_HIDE_CAPE
          , [3] = ARTIFACT_RING_OF_DEATH
          , [4] = ARTIFACT_TREEBORN_QUIVER
          , [5] = ARTIFACT_MONK_03
          , [6] = ARTIFACT_MONK_04
          , [7] = ARTIFACT_PIRATE_HAT
          , [8] = ARTIFACT_PIRATE_VEST
          , [9] = ARTIFACT_PIRATE_RING
          , [10] = ARTIFACT_PIRATE_HOOK
          , [11] = ARTIFACT_PIRATE_BOOTS
          , [12] = ARTIFACT_PIRATE_CHARM
          , [13] = ARTIFACT_SPIRIT_OF_OPPRESSION
          , [14] = ARTIFACT_RING_OF_FORGOTTEN
        }
        , [4] = {
          [0] = ARTIFACT_GREAT_AXE_OF_GIANT_SLAYING
          , [1] = ARTIFACT_NECKLACE_OF_POWER
          , [2] = ARTIFACT_NIGHTMARISH_RING
          , [3] = ARTIFACT_BOOTS_OF_SPEED
          , [4] = ARTIFACT_GOLDEN_HORSESHOE
          , [5] = ARTIFACT_WAYFARER_BOOTS
          , [6] = ARTIFACT_ENDLESS_BAG_OF_GOLD
          , [7] = ARTIFACT_BOOTS_OF_SWIFTNESS
          , [8] = ARTIFACT_RING_OF_CELERITY
          , [9] = ARTIFACT_BAND_OF_CONJURER
          , [10] = ARTIFACT_JINXING_BAND
          , [11] = ARTIFACT_RUNIC_WAR_AXE
          , [12] = ARTIFACT_RUNIC_WAR_HARNESS
          , [13] = ARTIFACT_DWARVEN_SMITHY_HUMMER
          , [14] = ARTIFACT_CROWN_OF_LEADER
          , [15] = ARTIFACT_BOOK_OF_POWER
          , [16] = ARTIFACT_LEGION_ADVANCED
          , [17] = ARTIFACT_SHIELD_OF_WOLF_DUCHY
          , [18] = ARTIFACT_PENDANT_OF_INTERFERENCE
          , [19] = ARTIFACT_BADGE_OF_SUN_CROSS
          , [20] = ARTIFACT_QUILL_OF_MAYOR
        }
        , [5] = {
          ...
          , [15] = ARTIFACT_MOONBLADE
          , [16] = ARTIFACT_RING_OF_THE_SHADOWBRAND
          , [17] = ARTIFACT_OGRE_CLUB
          , [18] = ARTIFACT_OGRE_SHIELD
          , [19] = ARTIFACT_TOME_OF_DESTRUCTION
          , [20] = ARTIFACT_TOME_OF_LIGHT_MAGIC
          , [21] = ARTIFACT_TOME_OF_DARK_MAGIC
          , [22] = ARTIFACT_TOME_OF_SUMMONING_MAGIC
          , [23] = ARTIFACT_SKULL_OF_MARKAL
          , [24] = ARTIFACT_RING_OF_MACHINE_AFFINITY
          , [25] = ARTIFACT_PENDANT_OF_BLIND
          , [26] = ARTIFACT_DRUM_OF_CHARGE
          , [27] = ARTIFACT_HORN_OF_CHARGE
          , [28] = ARTIFACT_GUARDIAN_01
          , [29] = ARTIFACT_GUARDIAN_02
          , [30] = ARTIFACT_GUARDIAN_03
          , [31] = ARTIFACT_FLAG_OF_CHARGE
          , [32] = ARTIFACT_ORB_AIR
          , [33] = ARTIFACT_ORB_EARTH
          , [34] = ARTIFACT_ORB_FIRE
          , [35] = ARTIFACT_ORB_WATER
        }
        , [6] = {
          [0] = ARTIFACT_UNICORN_HORN_BOW
          , [1] = ARTIFACT_STAFF_OF_VEXINGS
          , [2] = ARTIFACT_SHACKLES_OF_WAR
          , [3] = ARTIFACT_CROWN_OF_COURAGE
          , [4] = ARTIFACT_PLATE_MAIL_OF_STABILITY
          , [5] = ARTIFACT_PEDANT_OF_MASTERY
          , [6] = ARTIFACT_RING_OF_HASTE
          , [7] = ARTIFACT_CLOAK_OF_MOURNING
          , [8] = ARTIFACT_RING_OF_MAGI
          , [9] = ARTIFACT_TWISTING_NEITHER
          , [10] = ARTIFACT_SHAWL_OF_GREAT_LICH
          , [11] = ARTIFACT_NECROMANCER_PENDANT
          , [12] = ARTIFACT_LEGION_EXPERT
          , [13] = ARTIFACT_PENDANT_OF_STARDUST
          , [14] = ARTIFACT_INHERITANCE
          , [15] = ARTIFACT_RING_OF_HOLY_GRIFFIN
        }
        , [7] = {
          [0] = ARTIFACT_ANGEL_WINGS
          , [1] = ARTIFACT_ANGELIC_ALLIANCE
          , [2] = ARTIFACT_MASK_OF_DOPPELGANGER
          , [3] = ARTIFACT_HORN_OF_PLENTY
          , [4] = ARTIFACT_GEM_OF_PHANTOM
          , [5] = ARTIFACT_CURSE_SHOULDER
          , [6] = ARTIFACT_DRACONIC
          , [7] = ARTIFACT_SENTINEL
          , [8] = ARTIFACT_EIGHTFOLD
          , [9] = ARTIFACT_CODEX
          , [10] = ARTIFACT_BOOTS_OF_THE_WALKING_DEAD
          , [11] = ARTIFACT_BOOK_OF_MALASSA
          , [12] = ARTIFACT_HELMET_OF_HEAVENLY_ENLIGHTENMENT
        }
      };
    ...
    -- 宝物表 维度: 开局
      TTH_TABLE.Artifact8Start = {
        ...
        , [14] = ARTIFACT_RES_BASIC
        , [15] = ARTIFACT_BUCKLER
        , [16] = ARTIFACT_TITANS_TRIDENT
        , [17] = ARTIFACT_NECKLACE_OF_BRAVERY
        , [18] = ARTIFACT_EVERCOLD_ICICLE
        , [19] = ARTIFACT_RING_OF_LIFE
        , [20] = ARTIFACT_RES_EXPERT
        , [21] = ARTIFACT_PHOENIX_FEATHER_CAPE
        , [22] = ARTIFACT_HELM_OF_ENLIGHTMENT
        , [23] = ARTIFACT_CHAIN_MAIL_OF_ENLIGHTMENT
        , [24] = ARTIFACT_VALORIOUS_ARMOR
        , [25] = ARTIFACT_EARTHSLIDERS
        , [26] = ARTIFACT_BONESTUDDED_LEATHER
        , [27] = ARTIFACT_HELM_OF_CHAOS
        , [28] = ARTIFACT_TAROT_DECK
        , [29] = ARTIFACT_RES_ADVANCED
        , [30] = ARTIFACT_LEGION_BASIC
        , [31] = ARTIFACT_STEADFAST
        , [32] = ARTIFACT_REINCARNATION
        , [33] = ARTIFACT_MONK_01
        , [34] = ARTIFACT_MONK_02
        , [35] = ARTIFACT_ICEBERG_SHIELD
        , [36] = ARTIFACT_WEREWOLF_CLAW_NECKLACE
        , [37] = ARTIFACT_LION_HIDE_CAPE
        , [38] = ARTIFACT_RING_OF_DEATH
        , [39] = ARTIFACT_TREEBORN_QUIVER
        , [40] = ARTIFACT_MONK_03
        , [41] = ARTIFACT_MONK_04
        , [42] = ARTIFACT_PIRATE_HAT
        , [43] = ARTIFACT_PIRATE_VEST
        , [44] = ARTIFACT_PIRATE_RING
        , [45] = ARTIFACT_PIRATE_HOOK
        , [46] = ARTIFACT_PIRATE_BOOTS
        , [47] = ARTIFACT_PIRATE_CHARM
        , [48] = ARTIFACT_SPIRIT_OF_OPPRESSION
        , [49] = ARTIFACT_RING_OF_FORGOTTEN
      };
