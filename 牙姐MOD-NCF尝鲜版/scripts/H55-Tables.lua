	...
	-- 文本路径
		...
		-- Talent 1
			-- Cast
				...
				TTH_PATH.Talent["Cast"]["Hero"]["Gurvilin"] = TTH_PATH.Talent["Cast"]["Hero"]["Pre"].."Gurvilin.txt";
		...
		-- 技能池: 英雄天赋/主动宝物/主动技能
			TTH_TABLE.FuncTalent = {
				...
				, [TTH_ENUM.FuncActive] = {
					...
					, ["Gurvilin"] = {
						["Text"] = TTH_PATH.Talent["Cast"]["Hero"]["Gurvilin"]
						, [TTH_ENUM.FuncAtGate] = "TTH_TALENT.activeCastCreature"
						, [TTH_ENUM.FuncNotAtGate] = "TTH_TALENT.activeCastCreature"
					}
					, ["Adelaide"] = {
			...
			TTH_TABLE.Hero = {
						...
						, ["Nadaur"] = {
							...
							, ["Specialty"] = {
								...
								, [3] = {
									...
									, ["Stat"] = STAT_ATTACK
									, ["ArtifactId"] = ARTIFACT_LEGION_ADVANCED
									, ["PerkId"] = HERO_SKILL_EXPLODING_CORPSES
								}
							}
							, ["Attribute"] = {
								["Step"] = 5
				...
				-- TOWN_ACADEMY
					-- GuildMaster
						...
						, ["Gurvilin"] = {
							["Id"] = 45
							, ["Text"] = "/Text/Game/Heroes/TTH_ALL/Gurvilin/name.txt"
							, ["Race"] = TOWN_ACADEMY
							, ["Class"] = TTH_ENUM.GuildMaster
							, ["Group"] = TTH_ENUM.GroupMight
							, ["Specialty"] = {
						...
						, ["Hero9"] = {
							...
							, ["Specialty"] = {
								[1] = {
									...
									, ["Stat"] = STAT_ATTACK
									, ["ArtifactId"] = ARTIFACT_LEGION_BASIC
									, ["PerkId"] = HERO_SKILL_GOBLIN_SUPPORT
								}
							}
						}
						, ["Hero7"] = {
							...
							, ["Specialty"] = {
								[1] = {
									...
									, ["Stat"] = STAT_ATTACK
									, ["ArtifactId"] = ARTIFACT_LEGION_BASIC
									, ["PerkId"] = HERO_SKILL_DEFEND_US_ALL
								}
							}
						}
						, ["Hero8"] = {
