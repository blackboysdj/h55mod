...
H55SMOD_NecropolisHeroes = {
    ...
    , "Arantir", "Nemor", "Muscip", "Pelt", "Sandro", "Thant", "Vidomina"
};
...
H55_Paladins = {"Nicolai","GodricMP","Alaric","Axel","Saint Isabell","Maeve","RedHeavenHero06","Jeddite"};
...
H55_Seers = {"Havez","Minasli","Isher","Davius","Gurvilin"};
...
H55_Necromancers = {"Arantir","Nemor","Nimbus","Pelt","Sandro","Thant","Vidomina"};
...
H55_HavenHeroes = {"Nicolai","GodricMP","Maeve","Nathaniel","Axel","Brem","Jeddite","Markal","Orlando","RedHeavenHero03","RedHeavenHero06","Alaric","RedHeavenHero01","Christian","Sarge","Isabell","Mardigo","Ving","Orrin","Godric","Freyda","Ornella","GhostFSLord","Giar","Glen","Isabell_A1","Saint Isabell","RedHeavenHero01","RedHeavenHero02","RedHeavenHero05"};
...
H55_NecropolisHeroes = {"Gles","Pelt","Tamika","OrnellaNecro","Straker","Xerxon","Karissa","Archilus","Nimbus","Aislinn","Nemor","Muscip","Giovanni","Thant","Vidomina","Arantir","Aberrar","Effig","Sandro","Berein","Nikolay"};
...
H55_DwellingT1ConvCosts = {1000,2};
H55_DwellingT2ConvCosts = {2000,3};
H55_DwellingT3ConvCosts = {4000,5};
...
TTH_TABLE_Artifacts = {
	...
	, [6] = {
		[0] = ARTIFACT_GEM_OF_PHANTOM
		, [1] = ARTIFACT_UNICORN_HORN_BOW
		, [2] = ARTIFACT_STAFF_OF_VEXINGS
		, [3] = ARTIFACT_SHACKLES_OF_WAR
		, [4] = ARTIFACT_PLATE_MAIL_OF_STABILITY
		, [5] = ARTIFACT_PEDANT_OF_MASTERY
		, [6] = ARTIFACT_RING_OF_HASTE
		, [7] = ARTIFACT_CLOAK_OF_MOURNING
		, [8] = ARTIFACT_STAFF_OF_MAGI
		, [9] = ARTIFACT_RING_OF_MAGI
		, [10] = ARTIFACT_TWISTING_NEITHER
		, [11] = ARTIFACT_SHAWL_OF_GREAT_LICH
		, [12] = ARTIFACT_NECROMANCER_PENDANT
		, [13] = ARTIFACT_TOME_OF_DESTRUCTION
		, [14] = ARTIFACT_TOME_OF_LIGHT_MAGIC
		, [15] = ARTIFACT_TOME_OF_DARK_MAGIC
		, [16] = ARTIFACT_TOME_OF_SUMMONING_MAGIC
		, [17] = ARTIFACT_RING_OF_MACHINE_AFFINITY
		, [18] = ARTIFACT_PENDANT_OF_STARDUST
	}
	, [7] = {
...
-- by 牙姐 2021-2-14 20:3:39
-- begin 所有法术列表 1级魔法30%几率，2级魔法25%几率，3级魔法20%几率，4级魔法10%几率，5级魔法5%几率，群体魔法5%几率，强效魔法5%几率
...
-- by 牙姐 2019-5-18 17:02:33
-- begin 所有英雄控制台名对应
TTH_TABLE_HeroName = {
	["Nathaniel"] = "/Text/Game/Heroes/TTH_ALL/Nathaniel/name.txt"
	, ["Orrin"] = "/Text/Game/Heroes/TTH_ALL/Orrin/name.txt"
	, ["Mardigo"] = "/Text/Game/Heroes/TTH_ALL/Mardigo/name.txt"
	, ["Ving"] = "/Text/Game/Heroes/TTH_ALL/Ving/name.txt"
	, ["Sarge"] = "/Text/Game/Heroes/TTH_ALL/Sarge/name.txt"
	, ["Isabell"] = "/Text/Game/Heroes/TTH_ALL/Isabell/name.txt"
	, ["Christian"] = "/Text/Game/Heroes/TTH_ALL/Christian/name.txt"
	, ["RedHeavenHero02"] = "/Text/Game/Heroes/TTH_ALL/RedHeavenHero02/name.txt"
	, ["RedHeavenHero05"] = "/Text/Game/Heroes/TTH_ALL/RedHeavenHero05/name.txt"
	, ["Brem"] = "/Text/Game/Heroes/TTH_ALL/Brem/name.txt"
	, ["Nicolai"] = "/Text/Game/Heroes/TTH_ALL/Nicolai/name.txt"
	, ["GodricMP"] = "/Text/Game/Heroes/TTH_ALL/GodricMP/name.txt"
	, ["Alaric"] = "/Text/Game/Heroes/TTH_ALL/Alaric/name.txt"
	, ["Axel"] = "/Text/Game/Heroes/TTH_ALL/Axel/name.txt"
	, ["Saint Isabell"] = "/Text/Game/Heroes/TTH_ALL/Saint Isabell/name.txt"
	, ["Maeve"] = "/Text/Game/Heroes/TTH_ALL/Maeve/name.txt"
	, ["RedHeavenHero06"] = "/Text/Game/Heroes/TTH_ALL/RedHeavenHero06/name.txt"
	, ["Jeddite"] = "/Text/Game/Heroes/TTH_ALL/Jeddite/name.txt"
	, ["RedHeavenHero03"] = "/Text/Game/Heroes/TTH_ALL/RedHeavenHero03/name.txt"
	, ["Orlando"] = "/Text/Game/Heroes/TTH_ALL/Orlando/name.txt"
	, ["Markal"] = "/Text/Game/Heroes/TTH_ALL/Markal/name.txt"
	, ["Metlirn"] = "/Text/Game/Heroes/TTH_ALL/Metlirn/name.txt"
	, ["Ossir"] = "/Text/Game/Heroes/TTH_ALL/Ossir/name.txt"
	, ["Nadaur"] = "/Text/Game/Heroes/TTH_ALL/Nadaur/name.txt"
	, ["Linaas"] = "/Text/Game/Heroes/TTH_ALL/Linaas/name.txt"
	, ["Heam"] = "/Text/Game/Heroes/TTH_ALL/Heam/name.txt"
	, ["Gelu"] = "/Text/Game/Heroes/TTH_ALL/Gelu/name.txt"
	, ["Arniel"] = "/Text/Game/Heroes/TTH_ALL/Arniel/name.txt"
	, ["Kyrre"] = "/Text/Game/Heroes/TTH_ALL/Kyrre/name.txt"
	, ["Gillion"] = "/Text/Game/Heroes/TTH_ALL/Gillion/name.txt"
	, ["Itil"] = "/Text/Game/Heroes/TTH_ALL/Itil/name.txt"
	, ["Melodia"] = "/Text/Game/Heroes/TTH_ALL/Melodia/name.txt"
	, ["Jenova"] = "/Text/Game/Heroes/TTH_ALL/Jenova/name.txt"
	, ["Mephala"] = "/Text/Game/Heroes/TTH_ALL/Mephala/name.txt"
	, ["Gem"] = "/Text/Game/Heroes/TTH_ALL/Gem/name.txt"
	, ["Elleshar"] = "/Text/Game/Heroes/TTH_ALL/Elleshar/name.txt"
	, ["Ildar"] = "/Text/Game/Heroes/TTH_ALL/Ildar/name.txt"
	, ["Vaniel"] = "/Text/Game/Heroes/TTH_ALL/Vaniel/name.txt"
	, ["Vinrael"] = "/Text/Game/Heroes/TTH_ALL/Vinrael/name.txt"
	, ["Diraya"] = "/Text/Game/Heroes/TTH_ALL/Diraya/name.txt"
	, ["Havez"] = "/Text/Game/Heroes/TTH_ALL/Havez/name.txt"
	, ["Minasli"] = "/Text/Game/Heroes/TTH_ALL/Minasli/name.txt"
	, ["Isher"] = "/Text/Game/Heroes/TTH_ALL/Isher/name.txt"
	, ["Davius"] = "/Text/Game/Heroes/TTH_ALL/Davius/name.txt"
	, ["Gurvilin"] = "/Text/Game/Heroes/TTH_ALL/Gurvilin/name.txt"
	, ["Rissa"] = "/Text/Game/Heroes/TTH_ALL/Rissa/name.txt"
	, ["Razzak"] = "/Text/Game/Heroes/TTH_ALL/Razzak/name.txt"
	, ["Sufi"] = "/Text/Game/Heroes/TTH_ALL/Sufi/name.txt"
	, ["Cyrus"] = "/Text/Game/Heroes/TTH_ALL/Cyrus/name.txt"
	, ["Maahir"] = "/Text/Game/Heroes/TTH_ALL/Maahir/name.txt"
	, ["Timerkhan"] = "/Text/Game/Heroes/TTH_ALL/Timerkhan/name.txt"
	, ["Tan"] = "/Text/Game/Heroes/TTH_ALL/Tan/name.txt"
	, ["Emilia"] = "/Text/Game/Heroes/TTH_ALL/Emilia/name.txt"
	, ["Nur"] = "/Text/Game/Heroes/TTH_ALL/Nur/name.txt"
	, ["Astral"] = "/Text/Game/Heroes/TTH_ALL/Astral/name.txt"
	, ["Zehir"] = "/Text/Game/Heroes/TTH_ALL/Zehir/name.txt"
	, ["Faiz"] = "/Text/Game/Heroes/TTH_ALL/Faiz/name.txt"
	, ["Josephine"] = "/Text/Game/Heroes/TTH_ALL/Josephine/name.txt"
	, ["Calh"] = "/Text/Game/Heroes/TTH_ALL/Calh/name.txt"
	, ["Calid"] = "/Text/Game/Heroes/TTH_ALL/Calid/name.txt"
	, ["Deleb"] = "/Text/Game/Heroes/TTH_ALL/Deleb/name.txt"
	, ["Jazaz"] = "/Text/Game/Heroes/TTH_ALL/Jazaz/name.txt"
	, ["Marder"] = "/Text/Game/Heroes/TTH_ALL/Marder/name.txt"
	, ["Orlando2"] = "/Text/Game/Heroes/TTH_ALL/Orlando2/name.txt"
	, ["Efion"] = "/Text/Game/Heroes/TTH_ALL/Efion/name.txt"
	, ["Grok"] = "/Text/Game/Heroes/TTH_ALL/Grok/name.txt"
	, ["Malustar"] = "/Text/Game/Heroes/TTH_ALL/Malustar/name.txt"
	, ["Nymus"] = "/Text/Game/Heroes/TTH_ALL/Nymus/name.txt"
	, ["Oddrema"] = "/Text/Game/Heroes/TTH_ALL/Oddrema/name.txt"
	, ["Sovereign2"] = "/Text/Game/Heroes/TTH_ALL/Sovereign2/name.txt"
	, ["Agrael"] = "/Text/Game/Heroes/TTH_ALL/Agrael/name.txt"
	, ["Zydar"] = "/Text/Game/Heroes/TTH_ALL/Zydar/name.txt"
	, ["Ash"] = "/Text/Game/Heroes/TTH_ALL/Ash/name.txt"
	, ["Biara"] = "/Text/Game/Heroes/TTH_ALL/Biara/name.txt"
	, ["Calid2"] = "/Text/Game/Heroes/TTH_ALL/Calid2/name.txt"
	, ["Sheltem"] = "/Text/Game/Heroes/TTH_ALL/Sheltem/name.txt"
	, ["Archilus"] = "/Text/Game/Heroes/TTH_ALL/Archilus/name.txt"
	, ["Berein"] = "/Text/Game/Heroes/TTH_ALL/Berein/name.txt"
	, ["Gles"] = "/Text/Game/Heroes/TTH_ALL/Gles/name.txt"
	, ["Nikolay"] = "/Text/Game/Heroes/TTH_ALL/Nikolay/name.txt"
	, ["Straker"] = "/Text/Game/Heroes/TTH_ALL/Straker/name.txt"
	, ["Tamika"] = "/Text/Game/Heroes/TTH_ALL/Tamika/name.txt"
	, ["Xerxon"] = "/Text/Game/Heroes/TTH_ALL/Xerxon/name.txt"
	, ["Karissa"] = "/Text/Game/Heroes/TTH_ALL/Karissa/name.txt"
	, ["Aislinn"] = "/Text/Game/Heroes/TTH_ALL/Aislinn/name.txt"
	, ["Effig"] = "/Text/Game/Heroes/TTH_ALL/Effig/name.txt"
	, ["Giovanni"] = "/Text/Game/Heroes/TTH_ALL/Giovanni/name.txt"
	, ["OrnellaNecro"] = "/Text/Game/Heroes/TTH_ALL/OrnellaNecro/name.txt"
	, ["Aberrar"] = "/Text/Game/Heroes/TTH_ALL/Aberrar/name.txt"
	, ["Nimbus"] = "/Text/Game/Heroes/TTH_ALL/Nimbus/name.txt"
	, ["Muscip"] = "/Text/Game/Heroes/TTH_ALL/Muscip/name.txt"
	, ["Arantir"] = "/Text/Game/Heroes/TTH_ALL/Arantir/name.txt"
	, ["Nemor"] = "/Text/Game/Heroes/TTH_ALL/Nemor/name.txt"
	, ["Pelt"] = "/Text/Game/Heroes/TTH_ALL/Pelt/name.txt"
	, ["Sandro"] = "/Text/Game/Heroes/TTH_ALL/Sandro/name.txt"
	, ["Thant"] = "/Text/Game/Heroes/TTH_ALL/Thant/name.txt"
	, ["Vidomina"] = "/Text/Game/Heroes/TTH_ALL/Vidomina/name.txt"
	, ["Bersy"] = "/Text/Game/Heroes/TTH_ALL/Bersy/name.txt"
	, ["Maximus"] = "/Text/Game/Heroes/TTH_ALL/Maximus/name.txt"
	, ["Skeggy"] = "/Text/Game/Heroes/TTH_ALL/Skeggy/name.txt"
	, ["Tazar"] = "/Text/Game/Heroes/TTH_ALL/Tazar/name.txt"
	, ["Vilma"] = "/Text/Game/Heroes/TTH_ALL/Vilma/name.txt"
	, ["Bart"] = "/Text/Game/Heroes/TTH_ALL/Bart/name.txt"
	, ["Brand"] = "/Text/Game/Heroes/TTH_ALL/Brand/name.txt"
	, ["Egil"] = "/Text/Game/Heroes/TTH_ALL/Egil/name.txt"
	, ["KingTolghar"] = "/Text/Game/Heroes/TTH_ALL/KingTolghar/name.txt"
	, ["Ottar"] = "/Text/Game/Heroes/TTH_ALL/Ottar/name.txt"
	, ["Hangvul2"] = "/Text/Game/Heroes/TTH_ALL/Hangvul2/name.txt"
	, ["Una"] = "/Text/Game/Heroes/TTH_ALL/Una/name.txt"
	, ["Vegeyr"] = "/Text/Game/Heroes/TTH_ALL/Vegeyr/name.txt"
	, ["Hangvul"] = "/Text/Game/Heroes/TTH_ALL/Hangvul/name.txt"
	, ["Ingvar"] = "/Text/Game/Heroes/TTH_ALL/Ingvar/name.txt"
	, ["Rolf"] = "/Text/Game/Heroes/TTH_ALL/Rolf/name.txt"
	, ["Ufretin"] = "/Text/Game/Heroes/TTH_ALL/Ufretin/name.txt"
	, ["Wulfstan"] = "/Text/Game/Heroes/TTH_ALL/Wulfstan/name.txt"
	, ["Urunir"] = "/Text/Game/Heroes/TTH_ALL/Urunir/name.txt"
	, ["Menel"] = "/Text/Game/Heroes/TTH_ALL/Menel/name.txt"
	, ["Ferigl"] = "/Text/Game/Heroes/TTH_ALL/Ferigl/name.txt"
	, ["Sylsai"] = "/Text/Game/Heroes/TTH_ALL/Sylsai/name.txt"
	, ["Welygg"] = "/Text/Game/Heroes/TTH_ALL/Welygg/name.txt"
	, ["Ohtarig"] = "/Text/Game/Heroes/TTH_ALL/Ohtarig/name.txt"
	, ["Eruina"] = "/Text/Game/Heroes/TTH_ALL/Eruina/name.txt"
	, ["Dalom"] = "/Text/Game/Heroes/TTH_ALL/Dalom/name.txt"
	, ["Kelodin"] = "/Text/Game/Heroes/TTH_ALL/Kelodin/name.txt"
	, ["Shadwyn"] = "/Text/Game/Heroes/TTH_ALL/Shadwyn/name.txt"
	, ["Thralsai"] = "/Text/Game/Heroes/TTH_ALL/Thralsai/name.txt"
	, ["Agbeth"] = "/Text/Game/Heroes/TTH_ALL/Agbeth/name.txt"
	, ["Almegir"] = "/Text/Game/Heroes/TTH_ALL/Almegir/name.txt"
	, ["Inagost"] = "/Text/Game/Heroes/TTH_ALL/Inagost/name.txt"
	, ["Kastore"] = "/Text/Game/Heroes/TTH_ALL/Kastore/name.txt"
	, ["Raelag"] = "/Text/Game/Heroes/TTH_ALL/Raelag/name.txt"
	, ["Ranleth"] = "/Text/Game/Heroes/TTH_ALL/Ranleth/name.txt"
	, ["Sephinroth"] = "/Text/Game/Heroes/TTH_ALL/Sephinroth/name.txt"
	, ["Hero9"] = "/Text/Game/Heroes/TTH_ALL/Hero9/name.txt"
	, ["Hero7"] = "/Text/Game/Heroes/TTH_ALL/Hero7/name.txt"
	, ["Hero8"] = "/Text/Game/Heroes/TTH_ALL/Hero8/name.txt"
	, ["Azar"] = "/Text/Game/Heroes/TTH_ALL/Azar/name.txt"
	, ["Hero4"] = "/Text/Game/Heroes/TTH_ALL/Hero4/name.txt"
	, ["Hero6"] = "/Text/Game/Heroes/TTH_ALL/Hero6/name.txt"
	, ["Crag"] = "/Text/Game/Heroes/TTH_ALL/Crag/name.txt"
	, ["Gottai"] = "/Text/Game/Heroes/TTH_ALL/Gottai/name.txt"
	, ["Hero1"] = "/Text/Game/Heroes/TTH_ALL/Hero1/name.txt"
	, ["Hero2"] = "/Text/Game/Heroes/TTH_ALL/Hero2/name.txt"
	, ["Hero3"] = "/Text/Game/Heroes/TTH_ALL/Hero3/name.txt"
	, ["Kraal"] = "/Text/Game/Heroes/TTH_ALL/Kraal/name.txt"
	, ["KujinMP"] = "/Text/Game/Heroes/TTH_ALL/KujinMP/name.txt"
	, ["Kunyak"] = "/Text/Game/Heroes/TTH_ALL/Kunyak/name.txt"
	, ["Matewa"] = "/Text/Game/Heroes/TTH_ALL/Matewa/name.txt"
	, ["Quroq"] = "/Text/Game/Heroes/TTH_ALL/Quroq/name.txt"
	, ["Shiva"] = "/Text/Game/Heroes/TTH_ALL/Shiva/name.txt"
	, ["Zouleika"] = "/Text/Game/Heroes/TTH_ALL/Zouleika/name.txt"
	, ["Erika"] = "/Text/Game/Heroes/TTH_ALL/Erika/name.txt"
	, ["Mokka"] = "/Text/Game/Heroes/TTH_ALL/Mokka/name.txt"
}
-- end

-- by 牙姐 2018-10-15 19:38:14
-- begin
-- 英雄主动技能3
TTH_TABLE_HeroCustomAbilityOwner3 = {
	"Gelu"
	, "Thant"
	, "Archilus"
	, "Azar"
...
-- 过夜恢复使用次数
TTH_TABLE_HeroCustomAbility_Recovery = {
	"Gelu"
	, "Thant"
	, "Archilus"
	, "Azar"
...
-- by 牙姐 2019-11-29 00:14:05
-- begin 英雄升級所需经验
TTH_TABLE_HeroLevelUpRequireExp = {
	[1] = 0
	, [2] = 1000
	, [3] = 1000
	, [4] = 1200
