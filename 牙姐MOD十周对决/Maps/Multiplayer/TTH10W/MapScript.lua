...
TTH_TABLE.Artifacts4Map10W8Major = {
  ...
  , [6] = ARTIFACT_WAYFARER_BOOTS
  , [7] = ARTIFACT_MOONBLADE
  , [8] = ARTIFACT_BOOTS_OF_SWIFTNESS
  , [9] = ARTIFACT_GREAT_AXE_OF_GIANT_SLAYING
  , [10] = ARTIFACT_ICEBERG_SHIELD
  , [11] = ARTIFACT_NECKLACE_OF_POWER
  , [12] = ARTIFACT_NIGHTMARISH_RING
  , [13] = ARTIFACT_GOLDEN_HORSESHOE
  , [14] = ARTIFACT_RING_OF_CELERITY
  , [15] = ARTIFACT_BAND_OF_CONJURER
  , [16] = ARTIFACT_JINXING_BAND
  , [17] = ARTIFACT_BONESTUDDED_LEATHER
  , [18] = ARTIFACT_HELM_OF_CHAOS
  , [19] = ARTIFACT_RING_OF_THE_SHADOWBRAND
  , [20] = ARTIFACT_DWARVEN_SMITHY_HUMMER
  , [21] = ARTIFACT_BOOK_OF_POWER
  , [22] = ARTIFACT_SHIELD_OF_WOLF_DUCHY
  , [23] = ARTIFACT_RING_OF_FORGOTTEN
  , [24] = ARTIFACT_PENDANT_OF_INTERFERENCE
  , [25] = ARTIFACT_BADGE_OF_SUN_CROSS
}
